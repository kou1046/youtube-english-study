            ...
            {isVisible ? (
              <>
                <Box sx={{ display: "flex", justifyContent: "center" }}>
                  ...
                  <Box
                    component="p"
                    sx={{ fontWeight: "bold", fontSize: 25, m: 0, ml: 3 }}
                  >
                    {en}
                  </Box>
                </Box>
                <Box component="p" sx={{ fontSize: 23, m: 0 }}>
                  {ja}
                </Box>
              </>
            ) : (
            ...
            <Box component="ul" sx={{ display: "flex" }}>
              {phrases.map((phrase, i) => {
                return (
                  <Box
                    component="li"
                    key={index.toString() + "phrase-" + i.toString()}
                    sx={{ fontSize: 23, mr: 10 }}
                  >
                    {phrase}
                  </Box>
                );
